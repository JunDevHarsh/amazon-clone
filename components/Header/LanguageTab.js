...
import IndianFlag from "../../public/assets/india.svg";
  ...
  return (
    <div className="border-[1px] border-transparent hover:border-white rounded-[0.25rem]">
      <div className="dropdown-btn relative flex items-end justify-between mx-2 py-3 w-11 cursor-pointer">
        ...
        <div className="dropdown-content w-64 flex flex-col items-start rounded-md bg-[#f3f3f3] p-3 absolute -left-4 top-full opacity-0 pointer-events-none transition-opacity duration-700">
          <span
            id="arrow"
